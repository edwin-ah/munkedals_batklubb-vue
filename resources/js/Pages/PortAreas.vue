        ...
        <div class="container mx-auto mt-5">
            ...
            <div>
                <p class="text-center text-black">
                    ...
                    <a class="underline text-main font-semibold">Saltkällan</a>
            ...
            <div class="mt-10 pt-8 bg-white rounded shadow-xl">
                <h1 id="saltkallan" class=" text-center font-semibold text-main text-4xl uppercase work-sans"> Saltkällan </h1>
                <div class="flex md:flex-row justify-between flex-col py-3 md:py-8">
                    ...
                    <div class="md:w-6/12 flex">
                        <img class="rounded border shadow max-h-96" src="images/web_images/ny-brygga.jpg" alt="" />
                    </div>
                </div>
                <div class="flex flex-row invisible md:visible">
                    <div>
                        <img class="object-contain rounded px-5" src="images/web_images/saltkallan1.jpg" alt="" />
                    </div>
                    <div>
                        <img class="object-contain rounded px-5" src="images/web_images/saltkallan2.jpg" alt="" />
                    </div>
                    <div>
                        <img class="object-contain rounded px-5" src="images/web_images/saltkallan3.jpg" alt= />
                    </div>
                </div>
                ...
                <h1 id="ellingerod" class=" text-center font-semibold text-main text-4xl uppercase work-sans " >
                    Elllingeröd
                </h1>
                <div class=" flex md:flex-row justify-between flex-col py-3 md:py-8 " >
                    <div class=" md:w-6/12 sm:mb-5 lg:px-20 px-10 flex flex-col justify-center " >
                    ...
                    <div class="md:w-6/12 flex">
                        <img class="rounded border shadow max-h-96" src="images/web_images/ellingerod.jpg" alt="" />
                    </div>
                </div>
            </div>
        </div>
